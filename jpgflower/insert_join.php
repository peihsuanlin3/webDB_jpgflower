...
<body>
	<a href="cart.php">
  <img src="cart.png" alt="HTML tutorial" style="float:right;width:80px;height:80px;">
  <a href="logout.php">
  <img src="logout.png" alt="HTML tutorial" style="float:right;width:80px;height:80px;">
...
mysqli_select_db($link,"a0468");
	...
	$sqlstr_0="select pname from product where pno ='".$pno."';"; 
	...
	$sqlstr="insert into `join` values('".$pno."','".$mid."','".$pname['pname']."','".$today."');";
	
	mysqli_query($link,$sqlstr);
	mysqli_close($link);
	echo"<header><h1>加入購物車!</h1></header>";
