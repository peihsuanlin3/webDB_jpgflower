...
<?php
 ...
 $sqlstr = "SELECT `transaction`.tno,ttime FROM record,transaction WHERE record.tno=transaction.tno;";
 $result = mysqli_query($link,$sqlstr);
 
 $nrow = mysqli_num_rows($result);
 $i=1;
 echo"<div class='main'>";  
 echo"<table><tr><th>交易編號</th><td>交易時間</td></tr>";
 while($i<=$nrow){
  
  echo"<tr>";
  $record = mysqli_fetch_assoc($result);
 echo"<th>{$record['tno']}</th>";
